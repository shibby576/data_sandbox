...
#find the range of exercised options
options = []
for i in data_dict.values():
    if i['exercised_stock_options'] != 'NaN':
        options.append(i['exercised_stock_options'])
print('max options: ' + str(max(options)))
print('min options: ' + str(min(options)))
...
print('max salary: ' + str(max(salary)))
print('min salary: ' + str(min(salary)))
